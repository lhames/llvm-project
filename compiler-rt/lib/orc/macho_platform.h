...
using SectionExtent = llvm::orc::shared::SectionExtent;

using PerObjectRegisterableSections =
    llvm::orc::shared::PerObjectRegisterableSections;

using BlobPerObjectRegisterableSections =
    llvm::orc::shared::BlobPerObjectRegisterableSections;

using MachOJITDylibInitializers = llvm::orc::shared::MachOJITDylibInitializers;

using MachOPlatformInitializerSequence =
    llvm::orc::shared::MachOPlatformInitializerSequence;

using BlobMachOPlatformInitializerSequence =
    llvm::orc::shared::BlobMachOPlatformInitializerSequence;
