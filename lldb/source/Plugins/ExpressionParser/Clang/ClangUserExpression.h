...
class ClangUserExpression : public LLVMUserExpression {
  ...
  /// Grants the unit test access to the private helpers below.
...
private:
  ...
  /// Get the object pointer ("this") for a C++ method context. Does not use
  /// any instance state, so that it can be unit tested.
