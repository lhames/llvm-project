...
Error TPCEHFrameRegistrar::registerEHFrames(JITTargetAddress EHFrameSectionAddr,
  ...
  return shared::WrapperFunction<void(
      shared::BlobTargetAddress, uint64_t)>::call(TPC,
...
Error TPCEHFrameRegistrar::deregisterEHFrames(
  ...
  return shared::WrapperFunction<void(shared::BlobTargetAddress, uint64_t)>::
      call(TPC, DeregisterEHFrameWrapperFnAddr, EHFrameSectionAddr,
