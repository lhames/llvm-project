/*===-- wrapper-function.h - C APIs for orc-rt wrapper functions --*- C -*-===*\
|*                                                                            *|
...
|*===----------------------------------------------------------------------===*|
|*                                                                            *|
|* This file defines C APIs for working with orc-rt wrapper functions.        *|
|*                                                                            *|
\*===----------------------------------------------------------------------===*/

#ifndef ORC_RT_C_WRAPPER_FUNCTION_H
#define ORC_RT_C_WRAPPER_FUNCTION_H

#include "orc-rt-c/extern-c.h"
...
#endif /* ORC_RT_C_WRAPPER_FUNCTION_H */
